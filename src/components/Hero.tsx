          ...
          <div className="space-y-6 lg:space-y-8 text-center lg:text-left animate-fade-in flex flex-col justify-center">
            ...
            >
              ...
              >
                <Button
                  size="lg"
                  className="bg-primary hover:bg-primary/90 text-primary-foreground font-semibold text-lg px-8 py-6 shadow-lg hover:scale-105 transition-all w-full sm:w-auto"
                >
                  <svg
              ...
              {/* App Store Button */}
              <a
                href="https://apps.apple.com/app/idXXXXXXXXX" // 🔹 Replace with your real App Store URL
                target="_blank"
                rel="noopener noreferrer"
              >
                <Button
                  size="lg"
                  variant="outline"
                  className="border-2 border-primary text-foreground hover:bg-primary hover:text-primary-foreground font-semibold text-lg px-8 py-6 shadow-lg hover:scale-105 transition-all w-full sm:w-auto"
                >
                  <svg
                    className="mr-3 h-6 w-6"
                    viewBox="0 0 24 24"
