    ...
    >
      <div className="container mx-auto text-center relative z-10">
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 animate-fade-in">
          SmartHawker: Take Your Business<br />Online, Increase Your Profits!
        </h1>
        
        <p className="text-lg md:text-xl lg:text-2xl text-white/90 mb-12 max-w-3xl mx-auto animate-fade-in">
          The easiest app for millions of Indian hawkers and small shopkeepers. Accounting, stock management, and customer management, all in one place.
        </p>
